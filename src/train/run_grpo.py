...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "auto picks cuda>mps>cpu by what is available. cuda uses vLLM "
            "rollouts; mps/cpu use a local HF generate backend (no vLLM)."
        ),
    )
    parser.add_argument(
        "--dtype",
...
def main() -> None:
    ...
    print(
        f"[run_grpo] backend={backend} (requested {args.backend}) "
